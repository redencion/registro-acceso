...
class PersonasTest < ApplicationSystemTestCase
  ...
  test "creating a Persona" do
    ...
    fill_in "Credencial", with: @persona.credencial
    fill_in "Estatus", with: @persona.estatus
    fill_in "Fecha Registro", with: @persona.fecha_registro
    fill_in "Nombre", with: @persona.nombre
    fill_in "Organizacion", with: @persona.organizacion_id
